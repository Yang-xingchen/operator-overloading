...
public class LogHandle {
    ...
    public void postInit(ServiceHandle handle) {
        if (DEBUG.equals(level)) {
            StringBuilder msg = new StringBuilder("find service: {")
            ...
            messager.printNote("find service", handle.getTypeElement());
        }
    }
    ...
    public void preWrite(ServiceHandle handle, ServiceWriter serviceWriter) {
        if (DEBUG.equals(level)) {
            messager.printNote("write code: \n" + serviceWriter.code(), handle.getTypeElement());
        }
    }

    public void postWrite(ServiceHandle handle, ServiceWriter serviceWriter) {
