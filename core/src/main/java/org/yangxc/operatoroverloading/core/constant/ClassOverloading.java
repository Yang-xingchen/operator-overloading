...
public class ClassOverloading {
    ...
    static {
        ...
        BIG_DECIMAL_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.METHOD, "add", BIG_DECIMAL, BIG_DECIMAL));
        BIG_DECIMAL_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.METHOD, "subtract", BIG_DECIMAL, BIG_DECIMAL));
        BIG_DECIMAL_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.METHOD, "multiply", BIG_DECIMAL, BIG_DECIMAL));
        BIG_DECIMAL_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.METHOD, "divide", BIG_DECIMAL, BIG_DECIMAL));
        BIG_DECIMAL_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.METHOD, "remainder", BIG_DECIMAL, BIG_DECIMAL));
    ...
    static {
        ...
        BIG_INTEGER_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.METHOD, "add", BIG_INTEGER, BIG_INTEGER));
        BIG_INTEGER_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.METHOD, "subtract", BIG_INTEGER, BIG_INTEGER));
        BIG_INTEGER_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.METHOD, "multiply", BIG_INTEGER, BIG_INTEGER));
        BIG_INTEGER_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.METHOD, "divide", BIG_INTEGER, BIG_INTEGER));
        BIG_INTEGER_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.METHOD, "remainder", BIG_INTEGER, BIG_INTEGER));
    ...
    static {
        ...
        STRING_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.METHOD, "concat", STRING, STRING));
    ...
    static {
        ...
        BYTE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.PRIMITIVE, "+", BYTE, BYTE));
        BYTE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.PRIMITIVE, "-", BYTE, BYTE));
        BYTE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.PRIMITIVE, "*", BYTE, BYTE));
        BYTE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.PRIMITIVE, "/", BYTE, BYTE));
        BYTE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.PRIMITIVE, "%", BYTE, BYTE));
    ...
    static {
        ...
        SHORT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.PRIMITIVE, "+", SHORT, SHORT));
        SHORT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.PRIMITIVE, "-", SHORT, SHORT));
        SHORT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.PRIMITIVE, "*", SHORT, SHORT));
        SHORT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.PRIMITIVE, "/", SHORT, SHORT));
        SHORT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.PRIMITIVE, "%", SHORT, SHORT));
    ...
    static {
        ...
        INT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.PRIMITIVE, "+", INT, INT));
        INT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.PRIMITIVE, "-", INT, INT));
        INT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.PRIMITIVE, "*", INT, INT));
        INT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.PRIMITIVE, "/", INT, INT));
        INT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.PRIMITIVE, "%", INT, INT));
    ...
    static {
        ...
        LONG_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.PRIMITIVE, "+", LONG, LONG));
        LONG_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.PRIMITIVE, "-", LONG, LONG));
        LONG_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.PRIMITIVE, "*", LONG, LONG));
        LONG_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.PRIMITIVE, "/", LONG, LONG));
        LONG_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.PRIMITIVE, "%", LONG, LONG));
    ...
    static {
        ...
        FLOAT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.PRIMITIVE, "+", FLOAT, FLOAT));
        FLOAT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.PRIMITIVE, "-", FLOAT, FLOAT));
        FLOAT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.PRIMITIVE, "*", FLOAT, FLOAT));
        FLOAT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.PRIMITIVE, "/", FLOAT, FLOAT));
        FLOAT_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.PRIMITIVE, "%", FLOAT, FLOAT));
    ...
    static {
        ...
        DOUBLE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.ADD, OperatorMethodType.PRIMITIVE, "+", DOUBLE, DOUBLE));
        DOUBLE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.SUBTRACT, OperatorMethodType.PRIMITIVE, "-", DOUBLE, DOUBLE));
        DOUBLE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.MULTIPLY, OperatorMethodType.PRIMITIVE, "*", DOUBLE, DOUBLE));
        DOUBLE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.DIVIDE, OperatorMethodType.PRIMITIVE, "/", DOUBLE, DOUBLE));
        DOUBLE_CONTEXT.set(new OperatorOverloadingContext(OperatorType.REMAINDER, OperatorMethodType.PRIMITIVE, "%", DOUBLE, DOUBLE));
